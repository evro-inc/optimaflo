...
export function DataTable<TData, TValue>({ columns, data }: DataTableProps<TData, TValue>) {
  ...
  const [isDataAck, startDataAckTransition] = useTransition();
  ...
  const onDataAckButtonClick = () => {
    startDataAckTransition(() => {
      handleAcknowledgement().catch((error) => {
        throw new Error(error);
      });
    });
  };
  ...
  return (
    <div className="container mx-auto p-4">
      <h2 className="text-2xl font-bold mb-4">Firebase Links</h2>
        ...
        <div className="flex space-x-2">
          ...
          <Dialog>
            ...
            <DialogContent className="sm:max-w-[425px]">
              ...
              <DialogFooter>
                <Button type="submit" onClick={onDataAckButtonClick}>
                  Acknowledge
                </Button>
              </DialogFooter>
            </DialogContent>
