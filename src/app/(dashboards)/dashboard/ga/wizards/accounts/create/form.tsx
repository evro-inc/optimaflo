...
import { FeatureResponse, ProvisionAccountTicketRequest } from '@/src/types/types';
...
const FormCreateAccount = ({ tierLimits, accounts }) => {
  ...
  const handleNext = async () => {
    ...
    const currentFormFields = [`forms.${currentFormIndex}.displayName`, `forms.${currentFormIndex}.regionCode`];
