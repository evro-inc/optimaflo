...
const FormCreateAudience: React.FC<FormCreateProps> = ({
  ...
  const CardForm = ({ formIndex, simpleFormIndex, control, register, watch }) => {
    ...
    const {
      ...
      control: form.control,
      name: `forms.${formIndex}.filterClauses.${formIndex}.parentCardArray.${formIndex}.simpleFilter.simpleCardArray.${simpleFormIndex}.filterExpression.andGroup.filterExpressions`,
    });
