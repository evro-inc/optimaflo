...
import { FeatureResponse, AccountAccessBinding, Role } from '@/src/types/types';
...
import { DataRestrictions, Roles } from '../../../access-permissions/@index/items';
...
const FormUpdateAccountAccess = () => {
  ...
  const formDataDefaults: AccountAccessBinding[] = Object.values(selectedRowData).map(
    (rowData) => ({
      user: rowData.user,
