    ...
    <div>
      {fields.map((item: any, index: number) => (
        <div className="items-center mb-3 w-full" key={item.id}>
          ...
          {item.key === 'verticalThresholdsPercent' && verticalThresholdOn === 'true' && verticalThresholdUnits === 'PERCENT' && (
            <FormField
              control={control}
              name={`forms.${formIndex}.parameter.${index}.value`}
              render={({ field }) => (
          ...
          {item.key === 'verticalThresholdsPixels' && verticalThresholdOn === 'true' && verticalThresholdUnits === 'PIXELS' && (
            <FormField
              control={control}
              name={`forms.${formIndex}.parameter.${index}.value`}
              render={({ field }) => (
          ...
          {item.key === 'horizontalThresholdsPercent' && horizontalThresholdOn === 'true' && horizontalThresholdUnits === 'PERCENT' && (
            <FormField
              control={control}
              name={`forms.${formIndex}.parameter.${index}.value`}
              render={({ field }) => (
          ...
          {item.key === 'horizontalThresholdsPixels' && horizontalThresholdOn === 'true' && horizontalThresholdUnits === 'PIXELS' && (
            <FormField
              control={control}
              name={`forms.${formIndex}.parameter.${index}.value`}
              render={({ field }) => (
