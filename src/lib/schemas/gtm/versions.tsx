...
const ContainerVersionSchema = z.object({
  path: z.string(),
  accountId: z.string(),
  containerId: z.string(),
...
// Export the type inferred from ContainerVersionSchema for type safety
export type ContainerVersionType = z.infer<typeof ContainerVersionSchema>;
