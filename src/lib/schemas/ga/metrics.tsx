...
const MetricScopeSchema = z.enum([
...
const SingleFormSchema = z.object({
  name: z.string(),
  parameterName: z.string().max(40).regex(/^[A-Za-z][A-Za-z0-9_]*$/, { message: 'Must start with a letter and contain only alphanumeric and underscore characters.' }),
  displayName: z.string().min(1).max(82).regex(/^[A-Za-z][A-Za-z0-9_ ]*$/, { message: 'Must start with a letter and contain only alphanumeric, space, and underscore characters.' }),
