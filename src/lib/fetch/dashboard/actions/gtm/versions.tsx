...
import { FeatureResult, FeatureResponse, KeyEventType, GTMContainerVersion } from '@/src/types/types';
import {
                        ...
                        const deletePromises = Array.from(versionsToDelete).map(async (prop) => {
                            ...
                            try {
                                ...
                                if (response.ok) {
                                    ...
                                    versionsToDeleteMappedData.delete(`${accountId}-${containerId}-${containerVersionId}`);
                                    permissionDenied = errorResult ? true : permissionDenied;
                                }
                            } catch (error: any) {
