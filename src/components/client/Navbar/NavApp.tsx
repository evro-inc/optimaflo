...
import { ButtonProfile, ButtonSignOut } from '../Button/Button';
                ...
                <div className="hs-dropdown relative inline-flex [--placement:bottom-right]">
                  ...
                  >
                    ...
                    <div className="mt-2 py-2 first:pt-0 last:pb-0">
                      ...
                      <a
                        className="flex items-center gap-x-3.5 py-2 px-3 rounded-md text-sm text-gray-800 hover:bg-gray-100 focus:ring-2 focus:ring-blue-500 :text-gray-300"
                        href="#"
                      >
                        <svg
                          className="flex-none"
