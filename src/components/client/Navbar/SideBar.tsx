...
export default function SideBar() {
  return (
    <>
      {/* Sidebar Toggle */}
      <div className="sticky top-0 inset-x-0 z-20 bg-white-500 border-y px-4 sm:px-6 md:px-8 lg:hidden">
      ...
      <div
        ...
        className="hs-overlay hs-overlay-open:translate-x-0 -translate-x-full transition-all duration-300 transform hidden fixed top-0 left-0 bottom-0 z-[40] w-64 bg-white-500 border-r border-gray-200 pt-7 pb-10 overflow-y-auto scrollbar-y lg:block lg:translate-x-0 lg:right-auto lg:bottom-0 "
      >
        <div className="px-6">
          <Link
        ...
        >
          <ul className="space-y-1.5">
            ...
            <li className="hs-accordion" id="users-accordion">
              <Link
                className="hs-accordion-toggle flex items-center gap-x-3.5 py-2 px-2.5 hs-accordion-active:text-blue-600 hs-accordion-active:hover:bg-transparent text-sm text-slate-700 rounded-md hover:bg-gray-100 :text-white"
                href="#"
              >
                <svg
                  className="w-3.5 h-3.5"
