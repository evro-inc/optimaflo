...
const getLinkModeClasses = (variant) => {
  switch (variant) {
    ...
    case 'signUp':
      return 'cursor-pointer py-3 bg-blue-500 border border-blue-700 rounded-full text-white-500 inline-flex justify-center items-center gap-x-3 text-center hover:bg-blue-300 font-medium px-6 w-full lg:w-36 active:bg-blue-700 focus:outline-none focus:ring focus:ring-blue-100';
    case 'warning':
