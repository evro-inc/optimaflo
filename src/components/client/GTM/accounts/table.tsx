                  ...
                  <tr className="hover:bg-gray-100 ">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                      <Button
                        ...
                        text={'Update'}
                        type="button"
                        data-hs-overlay="#hs-large-modal" /* onClick={()=> handleGetDetails(account)} */ // Pass the account object
                      />

                      <div
                        id="hs-large-modal"
                        className="hs-overlay hidden w-full h-full fixed top-0 left-0 z-[60] overflow-x-hidden overflow-y-auto bg-white-500"
                      >
                        <div className="hs-overlay-open:opacity-100 hs-overlay-open:duration-500 opacity-0 transition-all lg:max-w-4xl lg:w-full m-3 lg:mx-auto">
                          <div className="flex flex-col bg-white-500 border shadow-sm rounded-xl">
