...
function FormRevertBuiltInVariable() {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      const response = await fetch(
        `/api/dashboard/gtm/accounts/${accountId}/containers/${containerId}/workspaces/${workspaceId}/variables-built-in/revert`,
        {
          method: 'POST',
          headers: {
...
export default FormRevertBuiltInVariable;
