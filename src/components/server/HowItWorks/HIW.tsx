                  ...
                  <div className="gap-y-4 text-left ">
                    <div>
                      <h2 className="block font-medium text-2xl md:text-3xl lg:text-4xl pt-5 pb-10">
                        We make it easy to manage data flows across Google data
                        products.
                      </h2>
                    </div>
                    <div>
                      <p className="text-lg">
                        ...
                        solution designed to address the common challenges faced
                        in managing large-scale data flows. Our suite of
                        features is built on the insights gained from extensive
                        experience in the field, and each one is designed to
                        streamline your workflows, enhance your data management,
