            ...
            <div className=" mx-auto px-4 sm:px-6 lg:px-8 py-24 space-y-8 bg-offBackground">
              <div className="text-left">
                ...
                <p className="text-lg">
                  ...
                  designed to address the common challenges faced in managing
                  large-scale data flows. Our suite of features is built on the
                  insights gained from extensive experience in the field, and
                  each one is designed to streamline your workflows, enhance
                  your data management, and provide you with actionable
                  insights.
                </p>
              </div>
