...
ALTER TABLE "public"."CheckoutSession" ENABLE ROW LEVEL SECURITY;

ALTER TABLE "public"."Customer" ENABLE ROW LEVEL SECURITY;

CREATE POLICY "Customer Select" ON "public"."Customer" FOR SELECT TO "authenticated" USING (("auth"."email"() = ( SELECT "User"."email"
   FROM "public"."User"
  WHERE ("Customer"."user_id" = "User"."id"))));

CREATE POLICY "Enable read access for all auth users" ON "public"."Feature" FOR SELECT TO "authenticated" USING (true);
...
CREATE POLICY "Enable read access for user subs" ON "public"."TierLimit" FOR SELECT TO "authenticated" USING ((EXISTS ( SELECT 1
   FROM ("public"."Subscription"
     JOIN "public"."Session" ON ((("Subscription"."user_id" = "Session"."user_id") AND ("Subscription"."id" = "TierLimit"."subscriptionId")))))));
...
ALTER TABLE "public"."ProductAccess" ENABLE ROW LEVEL SECURITY;

ALTER TABLE "public"."Session" ENABLE ROW LEVEL SECURITY;

CREATE POLICY "Session Access Policy - Select " ON "public"."Session" FOR SELECT TO "authenticated" USING (("auth"."email"() = ( SELECT "User"."email"
   FROM "public"."User"
...
CREATE POLICY "User Access Policy - Select" ON "public"."User" FOR SELECT TO "authenticated" USING (("auth"."email"() = "email"));

CREATE POLICY "User Access Policy - Update" ON "public"."User" FOR UPDATE TO "authenticated" USING (("auth"."email"() = "email"));

CREATE POLICY "User Checkout Session Access - Select" ON "public"."CheckoutSession" FOR SELECT TO "authenticated" USING (("auth"."email"() = ( SELECT "User"."email"
   FROM "public"."User"
  WHERE ("CheckoutSession"."user_id" = "User"."id"))));

CREATE POLICY "User GTM Access - Select" ON "public"."gtm" FOR SELECT TO "authenticated" USING (("auth"."email"() = ( SELECT "User"."email"
   FROM "public"."User"
  WHERE ("gtm"."user_id" = "User"."id"))));

CREATE POLICY "User Invoice Access - Select" ON "public"."Invoice" FOR SELECT TO "authenticated" USING (("auth"."email"() = ( SELECT "User"."email"
   FROM "public"."User"
  WHERE ("Invoice"."user_id" = "User"."id"))));

CREATE POLICY "User Product Access - Select" ON "public"."ProductAccess" FOR SELECT TO "authenticated" USING (("auth"."email"() = ( SELECT "User"."email"
   FROM "public"."User"
  WHERE ("ProductAccess"."user_id" = "User"."id"))));

CREATE POLICY "User Subscription Access - Select" ON "public"."Subscription" FOR SELECT TO "authenticated" USING (("auth"."email"() = ( SELECT "User"."email"
   FROM "public"."User"
  WHERE ("Subscription"."user_id" = "User"."id"))));

ALTER TABLE "public"."_prisma_migrations" ENABLE ROW LEVEL SECURITY;

ALTER TABLE "public"."gtm" ENABLE ROW LEVEL SECURITY;
